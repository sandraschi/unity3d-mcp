...
const BACKEND_NAME: &str = "unity3d-mcp-backend.exe";
const BACKEND_PORT: u16 = 10700;
const BACKEND_TAG: &str = "unity3d-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "UNITY3D_MCP_PORT";
const ENV_HOST: &str = "UNITY3D_MCP_HOST";
const ENV_TAURI: &str = "UNITY3D_MCP_TAURI";
